...
from dataloader import std, avg, test_features, test_labels, test_words
...
encoder=keras.models.load_model("./models/"+model_name+".h5")
encoder.compile()
...
clf=pickle.load(open("./models/"+model_name+"_classifier.sav", "rb"))
