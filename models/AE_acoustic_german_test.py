...
string="./acoustic/aecdnn_german/aecdnngerman"+fold+".h5"
model= keras.models.load_model(string)
string="./acoustic/aecdnn_german/aecdnn+encodergerman"+fold+".h5"
...
string="./classifiers/acoustic/aecdnngerman"+fold+".sav"
