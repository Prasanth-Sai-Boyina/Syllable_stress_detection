...
string="./acoustic/aecdnn_italian/aecdnnitalian"+fold+".h5"
model= keras.models.load_model(string)
string="./acoustic/aecdnn_italian/aecdnn+encoderitalian"+fold+".h5"
...
string="./classifiers/acoustic/aecdnnitalian"+fold+".sav"
