...
string="./context/aecdnn_german/aecdnngerman"+fold+".h5"
model= keras.models.load_model(string)
string="./context/aecdnn_german/aecdnn+encodergerman"+fold+".h5"
...
string="./classifiers/context/aecdnngerman"+fold+".sav"
