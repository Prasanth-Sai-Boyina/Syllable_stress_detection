...
string="./acoustic/saecdnn_mixed/saecdnnmixed"+fold+".h5"
model= keras.models.load_model(string)
string="./acoustic/saecdnn_mixed/saecdnn+encodermixed"+fold+".h5"
...
string="./classifiers/acoustic/saecdnnmixed"+fold+".sav"
