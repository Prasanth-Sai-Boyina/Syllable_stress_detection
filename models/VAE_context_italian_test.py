...
string="./context/vaecdnn_italian/vaecdnnitalian"+fold+".h5"
model= keras.models.load_model(string)
string="./context/vaecdnn_italian/vaecdnn+encoderitalian"+fold+".h5"
...
string="./classifiers/context/vaecdnnitalian"+fold+".sav"
