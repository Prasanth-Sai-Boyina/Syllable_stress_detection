...
string="./context/vaecdnn_mixed/vaecdnnmixed"+fold+".h5"
model= keras.models.load_model(string)
string="./context/vaecdnn_mixed/vaecdnn+encodermixed"+fold+".h5"
...
string="./classifiers/context/vaecdnnmixed"+fold+".sav"
