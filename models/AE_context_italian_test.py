...
string="./context/aecdnn_italian/aecdnnitalian"+fold+".h5"
model= keras.models.load_model(string)
string="./context/aecdnn_italian/aecdnn+encoderitalian"+fold+".h5"
...
string="./classifiers/context/aecdnnitalian"+fold+".sav"
