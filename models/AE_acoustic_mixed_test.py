...
string="./acoustic/aecdnn_mixed/aecdnnmixed"+fold+".h5"
model= keras.models.load_model(string)
string="./acoustic/aecdnn_mixed/aecdnn+encodermixed"+fold+".h5"
...
string="./classifiers/acoustic/aecdnnmixed"+fold+".sav"
