...
string="./acoustic/vaecdnn_german/vaecdnngerman"+fold+".h5"
model= keras.models.load_model(string)
string="./acoustic/vaecdnn_german/vaecdnn+encodergerman"+fold+".h5"
...
string="./classifiers/acoustic/vaecdnngerman"+fold+".sav"
