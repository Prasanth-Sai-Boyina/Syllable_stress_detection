...
string="./acoustic/saecdnn_italian/saecdnnitalian"+fold+".h5"
model= keras.models.load_model(string)
string="./acoustic/saecdnn_italian/saecdnn+encoderitalian"+fold+".h5"
...
string="./classifiers/acoustic/saecdnnitalian"+fold+".sav"
